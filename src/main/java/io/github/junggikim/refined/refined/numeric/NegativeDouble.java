...
public final class NegativeDouble extends AbstractRefined<Double> implements Newtype<Double> {
    ...
    public static NegativeDouble ofOrElse(@org.jetbrains.annotations.Nullable Double value, @org.jetbrains.annotations.NotNull Double defaultValue) {
        Validation<Violation, NegativeDouble> result = of(value);
