...
public final class ValidShortString extends AbstractRefined<String> implements Newtype<String> {
    ...
    public static ValidShortString ofOrElse(@org.jetbrains.annotations.Nullable String value, @org.jetbrains.annotations.NotNull String defaultValue) {
        Validation<Violation, ValidShortString> result = of(value);
