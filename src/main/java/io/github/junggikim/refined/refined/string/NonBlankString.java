...
public final class NonBlankString extends AbstractRefined<String> implements Newtype<String> {
    ...
    public static NonBlankString ofOrElse(@org.jetbrains.annotations.Nullable String value, @org.jetbrains.annotations.NotNull String defaultValue) {
        Validation<Violation, NonBlankString> result = of(value);
