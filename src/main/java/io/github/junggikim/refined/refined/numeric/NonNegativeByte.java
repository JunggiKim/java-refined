...
/** Wraps a {@code byte} value that is non-negative ({@code >= 0}). */
public final class NonNegativeByte extends AbstractRefined<Byte> implements Newtype<Byte> {
    ...
    public static NonNegativeByte ofOrElse(@org.jetbrains.annotations.Nullable Byte value, @org.jetbrains.annotations.NotNull Byte defaultValue) {
        Validation<Violation, NonNegativeByte> result = of(value);
