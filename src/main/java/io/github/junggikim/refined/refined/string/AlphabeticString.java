...
public final class AlphabeticString extends AbstractRefined<String> implements Newtype<String> {
    ...
    public static AlphabeticString ofOrElse(@org.jetbrains.annotations.Nullable String value, @org.jetbrains.annotations.NotNull String defaultValue) {
        Validation<Violation, AlphabeticString> result = of(value);
