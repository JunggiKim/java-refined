...
/** Wraps a {@code String} where all cased characters are lowercase. */
public final class LowerCaseString extends AbstractRefined<String> implements Newtype<String> {
    ...
    public static LowerCaseString ofOrElse(@org.jetbrains.annotations.Nullable String value, @org.jetbrains.annotations.NotNull String defaultValue) {
        Validation<Violation, LowerCaseString> result = of(value);
