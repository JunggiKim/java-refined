...
public final class UriString extends AbstractRefined<String> implements Newtype<String> {
    ...
    public static UriString ofOrElse(@org.jetbrains.annotations.Nullable String value, @org.jetbrains.annotations.NotNull String defaultValue) {
        Validation<Violation, UriString> result = of(value);
