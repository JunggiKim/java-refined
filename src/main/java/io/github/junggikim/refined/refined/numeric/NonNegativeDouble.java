...
public final class NonNegativeDouble extends AbstractRefined<Double> implements Newtype<Double> {
    ...
    public static NonNegativeDouble ofOrElse(@org.jetbrains.annotations.Nullable Double value, @org.jetbrains.annotations.NotNull Double defaultValue) {
        Validation<Violation, NonNegativeDouble> result = of(value);
