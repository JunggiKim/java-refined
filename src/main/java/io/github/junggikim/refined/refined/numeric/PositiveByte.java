...
public final class PositiveByte extends AbstractRefined<Byte> implements Newtype<Byte> {
    ...
    public static PositiveByte ofOrElse(@org.jetbrains.annotations.Nullable Byte value, @org.jetbrains.annotations.NotNull Byte defaultValue) {
        Validation<Violation, PositiveByte> result = of(value);
