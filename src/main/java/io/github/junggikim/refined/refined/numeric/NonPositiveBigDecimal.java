...
public final class NonPositiveBigDecimal extends AbstractRefined<BigDecimal> implements Newtype<BigDecimal> {
    ...
    public static NonPositiveBigDecimal ofOrElse(@org.jetbrains.annotations.Nullable BigDecimal value, @org.jetbrains.annotations.NotNull BigDecimal defaultValue) {
        Validation<Violation, NonPositiveBigDecimal> result = of(value);
