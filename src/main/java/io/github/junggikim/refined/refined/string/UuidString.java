...
public final class UuidString extends AbstractRefined<String> implements Newtype<String> {
    ...
    public static UuidString ofOrElse(@org.jetbrains.annotations.Nullable String value, @org.jetbrains.annotations.NotNull String defaultValue) {
        Validation<Violation, UuidString> result = of(value);
