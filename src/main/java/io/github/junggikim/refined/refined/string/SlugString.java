...
/** Wraps a {@code String} that is a valid URL slug ({@code a-z, 0-9, hyphens}). */
public final class SlugString extends AbstractRefined<String> implements Newtype<String> {
    ...
    public static SlugString ofOrElse(@org.jetbrains.annotations.Nullable String value, @org.jetbrains.annotations.NotNull String defaultValue) {
        Validation<Violation, SlugString> result = of(value);
