...
public final class CreditCardString extends AbstractRefined<String> implements Newtype<String> {
    ...
    public static CreditCardString ofOrElse(@org.jetbrains.annotations.Nullable String value, @org.jetbrains.annotations.NotNull String defaultValue) {
        Validation<Violation, CreditCardString> result = of(value);
