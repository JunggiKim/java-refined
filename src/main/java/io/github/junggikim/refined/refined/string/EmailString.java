...
public final class EmailString extends AbstractRefined<String> implements Newtype<String> {
    ...
    public static EmailString ofOrElse(@org.jetbrains.annotations.Nullable String value, @org.jetbrains.annotations.NotNull String defaultValue) {
        Validation<Violation, EmailString> result = of(value);
