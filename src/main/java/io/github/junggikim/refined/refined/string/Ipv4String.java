...
public final class Ipv4String extends AbstractRefined<String> implements Newtype<String> {
    ...
    public static Ipv4String ofOrElse(@org.jetbrains.annotations.Nullable String value, @org.jetbrains.annotations.NotNull String defaultValue) {
        Validation<Violation, Ipv4String> result = of(value);
