...
public final class ValidLongString extends AbstractRefined<String> implements Newtype<String> {
    ...
    public static ValidLongString ofOrElse(@org.jetbrains.annotations.Nullable String value, @org.jetbrains.annotations.NotNull String defaultValue) {
        Validation<Violation, ValidLongString> result = of(value);
