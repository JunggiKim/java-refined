...
public final class JsonString extends AbstractRefined<String> implements Newtype<String> {
    ...
    public static JsonString ofOrElse(@org.jetbrains.annotations.Nullable String value, @org.jetbrains.annotations.NotNull String defaultValue) {
        Validation<Violation, JsonString> result = of(value);
