...
public final class IsbnString extends AbstractRefined<String> implements Newtype<String> {
    ...
    public static IsbnString ofOrElse(@org.jetbrains.annotations.Nullable String value, @org.jetbrains.annotations.NotNull String defaultValue) {
        Validation<Violation, IsbnString> result = of(value);
